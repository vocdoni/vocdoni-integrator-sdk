...
export const BallotType = {
  ...
  Approval: 'approval',
  /**
   * A ranking: one rank per option, in choice order, no two the same, **highest = best**.
   * Needs a declared `ranked` name on a protocol that admits it; see {@link inferQuestionBallotType}.
   */
  Ranked: 'ranked',
  Budget: 'budget',
  Quadratic: 'quadratic',
