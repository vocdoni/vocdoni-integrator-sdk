...
- 6f3fa07: Disable voting before a process's scheduled start, and explain why the vote button is disabled.
...
- Updated dependencies [7165b53]
  ...
  - @vocdoni/ballot@1.2.1

## 2.1.0

### Minor Changes

- 49e57c8: Merge the voter CSP client into `ElectionsClient`; `client.processes` stays as a deprecated alias.
